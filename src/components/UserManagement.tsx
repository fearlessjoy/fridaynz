          ...
          <table className="w-full caption-bottom text-sm">
            <thead className="border-b">
              <tr className="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                ...
                <th className="h-12 px-4 text-left align-middle font-medium">Access Level</th>
                {canManageUsers && <th className="h-12 px-4 text-left align-middle font-medium">Actions</th>}
              </tr>
            </thead>
            <tbody>
